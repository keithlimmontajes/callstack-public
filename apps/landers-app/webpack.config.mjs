  ...
  return {
    ...
    module: {
      ...
      rules: [
         ...
         */
        {
          // test: Repack.ASSET_EXTENSIONS.filter(ext => ext !== 'svg'),
    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPlugin({
        ...
        exposes: {
          ...
          ShoppingListScreen:
            './src/screens/ShoppingListScreen/screens/AllShoppingLists',
          HomeBanners: './src/screens/HomeScreen/screens/HomeBanners',
          CategoryScreen:
            './src/screens/Categories/screens/Categories/Categories',
          ProductDetailsScreen: './src/screens/ProductDetailScreen',
          LandersFooter: './src/components/LandersFooter',
          LandersWebView: './src/screens/WebViewScreen',
          CategoryCard: './src/components/CategoryCard',
          LandersExperience: './src/components/LandersExperience',
        },
        shared: {
          react: {
            singleton: true,
